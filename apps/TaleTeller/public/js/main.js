...
switch (view) {
    ...
    case 'create': {
        const { initLastFragmentController } = await import('./contorllers/lastFragmentController.js');
        const { initTaleSubmitController } = await import('./controller/taleSubmitController.js');
